...
static void on_call_media_state(pjsua_call_id call_id) {
	...
	printf("media_status %d call_id: %d media_cnt %d ci.conf_slot %d aud.conf_slot %d\n",
			ci.media_status,
			call_id,
			ci.media_cnt,
			ci.conf_slot,
	...
	printf("media_status call status %s\n", ci.state_text.ptr);
